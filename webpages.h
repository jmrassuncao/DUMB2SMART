 ...
 */
 ...
 String getPage(){
  ...
  page +=                 proj_ver;
  page +=               "</h2>";
  page +=               "<p>This project uses the MQTT function LWT so the broker will know if the device is On or OFF. The topic to get the LWT is <small><em style='color: #ababab;'>";
  page +=                 MQTT_WILL_TOPIC;
  page +=               "</em></small></p>";
  page +=             "</div>";
